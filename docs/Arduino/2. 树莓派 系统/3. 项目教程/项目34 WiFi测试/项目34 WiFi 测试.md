...
可以在此路径下打开代码“**Project_34_WiFi_Test**”。
...
![图片不存在](../../../media/3b176da5112f1dc61e00d10193884eea.png)

**注意：** 如果打开串口监视器且设置波特率为115200之后，串口监视器窗口没有显示如上信息，可以按下ESP32的复位键![图片不存在](../../../media/515a31c10d414cae43980905e7df1879.jpg)）
