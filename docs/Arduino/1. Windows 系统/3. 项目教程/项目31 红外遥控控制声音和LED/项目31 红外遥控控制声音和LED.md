...
打开Arduino IDE，单击“**项目**”→“**包含库**”→“**添加.ZIP库...**”。在弹出窗口中找到该目录下名为**Keyes ESP32 中级版学习套件\4. Arduino C 教程\1. Windows 系统\2. Arduino 库文件\IRremoteESP8266-2.7.4.ZIP**的文件，先选中**IRremoteESP8266-2.7.4.ZIP**文件，再单击“**打开**”。
![图片不存在](../../../media/1732a39a124b267089e502f5f254946e.png)
![图片不存在](../../../media/7cd821d48b166d440531a7bf00e3a423.png)

<span style="color: rgb(255, 76, 65);">IRremoteESP8266</span>库添加完成后，你可以打开我们提供的代码：
<br>
<br>

本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 中级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目31 红外遥控控制声音和LED\Project_31.1_Decoded_IR_Signal** 。
...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 中级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目31 红外遥控控制声音和LED\Project_31.2_IR_Control_Sound_And_LED** 。
