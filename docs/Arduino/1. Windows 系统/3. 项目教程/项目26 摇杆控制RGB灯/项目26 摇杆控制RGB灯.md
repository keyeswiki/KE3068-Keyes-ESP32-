...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 中级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目26 摇杆控制RGB灯\Project_26.1_Read_Rocker_Value** 。
...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 中级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目26 摇杆控制RGB灯\Project_26.2_Rocker_Control_Light** 。
